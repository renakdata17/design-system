...
const SECTIONS: SettingsNavSection[] = [
  {
    title: "Account",
    items: [
      { id: "profile", label: "Profile", icon: <UserIcon className="h-4 w-4" />, description: "Manage your personal information" },
      { id: "billing", label: "Billing", icon: <CreditCardIcon className="h-4 w-4" />, description: "Manage your subscription and payments" },
      { id: "team", label: "Team", icon: <UsersIcon className="h-4 w-4" />, badge: 3, description: "Invite and manage team members" },
    ],
  },
  {
    title: "Preferences",
    items: [
      { id: "notifications", label: "Notifications", icon: <BellIcon className="h-4 w-4" />, description: "Choose what notifications you receive" },
      { id: "security", label: "Security", icon: <ShieldIcon className="h-4 w-4" />, description: "Password and security settings" },
      { id: "appearance", label: "Appearance", icon: <PaletteIcon className="h-4 w-4" />, description: "Customize the look and feel" },
      { id: "language", label: "Language", icon: <GlobeIcon className="h-4 w-4" />, disabled: true, description: "Coming soon" },
    ],
  },
];
