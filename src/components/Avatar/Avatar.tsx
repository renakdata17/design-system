...
function Avatar({
  ...
  ref,
  ...props
}: AvatarProps & { ref?: React.Ref<React.ComponentRef<typeof AvatarPrimitive.Root>> }) {
  return (
...
function AvatarImage({
  ...
  ref,
  ...props
}: AvatarImageProps & { ref?: React.Ref<React.ComponentRef<typeof AvatarPrimitive.Image>> }) {
