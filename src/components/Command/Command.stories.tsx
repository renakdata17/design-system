      ...
      <Command>
        ...
        <CommandList>
          ...
          <CommandGroup heading="Pages">
            ...
            <CommandItem>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/></svg>
              Billing
        ...
        <CommandDialog open={open} onOpenChange={setOpen} label="Command Palette">
          ...
          <CommandList>
            ...
            <CommandGroup heading="Settings">
              ...
              <CommandItem onSelect={() => setOpen(false)}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2zm0 5v5l4 2"/></svg>
                Theme
              </CommandItem>
            </CommandGroup>
            <CommandSeparator />
