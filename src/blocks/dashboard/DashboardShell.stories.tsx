            ...
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="flex items-center gap-4">
                ...
                <div className="flex-1 space-y-1">
                  ...
                  <p className="text-xs text-[hsl(var(--la-muted-foreground))]">customer{i}@example.com</p>
                </div>
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardContent className="pt-6">
            <p className="text-[hsl(var(--la-muted-foreground))]">Product grid would appear here.</p>
          </CardContent>
        </Card>
      </div>
    ),
