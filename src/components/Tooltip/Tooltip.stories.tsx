...
export const AllSizes: Story = {
  render: () => (
    ...
    >
      <TooltipRoot>
        <TooltipTrigger
          style={{ padding: "8px 16px", border: "1px solid #e2e8f0", borderRadius: "4px" }}
        >
          Short
        </TooltipTrigger>
  ...
  render: () => (
    ...
    >
      <TooltipRoot>
        ...
        <TooltipContent>
          A very long tooltip message that tests how the component handles overflow and wrapping of
          text content in constrained layouts
        </TooltipContent>
      </TooltipRoot>
      <TooltipRoot>
        <TooltipTrigger
