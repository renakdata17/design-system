...
export const Default: Story = {
  render: () => (
    <ScrollArea
      style={{ height: 200, width: 300, border: "1px solid hsl(var(--border))", borderRadius: 8 }}
    >
...
export const WithLongText: Story = {
  render: () => (
    <ScrollArea
      style={{ height: 300, width: 400, border: "1px solid hsl(var(--border))", borderRadius: 8 }}
    >
...
export const SmallContainer: Story = {
  render: () => (
    <ScrollArea
      style={{ height: 100, width: 200, border: "1px solid hsl(var(--border))", borderRadius: 8 }}
    >
      <div style={{ padding: 12 }}>
        {Array.from({ length: 20 }, (_, i) => (
          <div
            key={i}
            style={{ fontSize: 12, padding: "4px 0", color: "hsl(var(--muted-foreground))" }}
          >
