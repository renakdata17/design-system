...
const sampleContent = (
  <div className="space-y-4">
    <p>
      React 19 introduces a fundamentally new mental model for handling async operations in your
      components. The new Actions API removes the need for manually tracking loading states, errors,
    ...
    <p>
      With React 19, you can pass async functions directly to form elements. React automatically
      handles pending states, error boundaries, and optimistic updates — all without extra
      boilerplate.
    </p>
...
function Cart() {
  return (
    ...
    <p>
      ...
      <code className="bg-muted px-1 py-0.5 rounded text-sm">useActionState</code>,{" "}
    ...
    <h3 id="useactionstate" className="text-xl font-semibold text-foreground mt-6">
      useActionState
    </h3>
    <p>
      This hook allows you to update state based on the result of a form action. It returns the
      current state of the action plus a dispatch function.
    </p>
    <h3 id="useoptimistic" className="text-xl font-semibold text-foreground mt-6">
      useOptimistic
    </h3>
    <p>
      The <code className="bg-muted px-1 py-0.5 rounded text-sm">useOptimistic</code> hook lets you
      show a different state while an async action is underway, then automatically revert if it
      fails.
    </p>
    ...
    <PostDetail
      ...
      content={
        <p className="text-muted-foreground">
          ...
          expose the right primitives and let users build what they need. Over-engineering is always
