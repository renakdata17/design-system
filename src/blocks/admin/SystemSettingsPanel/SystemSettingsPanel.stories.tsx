...
const sampleFlags: FeatureFlag[] = [
  ...
  },
  {
    id: "beta_features",
    name: "Beta Features",
    description: "Enable access to experimental beta features.",
    enabled: false,
  },
  {
    id: "maintenance_mode",
  ...
  },
  {
    id: "ai_assistant",
    name: "AI Assistant",
    description: "Enable the AI assistant integration.",
    enabled: true,
  },
  {
    id: "analytics",
    name: "Analytics",
    description: "Enable product analytics and tracking.",
    enabled: true,
  },
];
