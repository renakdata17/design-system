...
const categoryConfig: Record<IntegrationCategory, { label: string; color: string }> = {
  analytics: { label: "Analytics", color: "bg-blue-500/10 text-blue-600 border-blue-500/20" },
  communication: { label: "Communication", color: "bg-purple-500/10 text-purple-600 border-purple-500/20" },
  crm: { label: "CRM", color: "bg-emerald-500/10 text-emerald-600 border-emerald-500/20" },
  developer: { label: "Developer", color: "bg-slate-500/10 text-slate-600 border-slate-500/20" },
  marketing: { label: "Marketing", color: "bg-pink-500/10 text-pink-600 border-pink-500/20" },
  payment: { label: "Payment", color: "bg-amber-500/10 text-amber-600 border-amber-500/20" },
