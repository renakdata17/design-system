        ...
        <div className="relative">
          ...
          <ol className="space-y-0">
            {orderedItems.map((item, index) => {
              ...
              return (
                <li key={item.id} className={cn("relative pl-12", compact ? "pb-4" : "pb-8", isLast && "pb-0")}>
                  ...
                  <div className={cn("flex flex-col", compact ? "gap-0.5" : "gap-1")}>
                    ...
                    <p className={cn("font-medium leading-snug text-foreground", compact ? "text-sm" : "text-base")}>
                      {item.title}
                    </p>
